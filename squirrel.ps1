...
Exec { .$squirrel -releasify "$build_dir\vigilantcupcake.$version.nupkg" -releaseDir $release_dir -setupIcon "$src_dir\VC2-nobg-whitecake.ico" | Write-Output } # -n "/a /f build/windows/app_signing.p12 /p SECRETPASSWORD"
